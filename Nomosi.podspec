#
# Be sure to run `pod lib lint Nomosi.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'Nomosi'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Nomosi.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'Nomosi/Classes/**/*'
  
  # s.resource_bundles = {
  #   'Nomosi' => ['Nomosi/Assets/*.png']
  # }
